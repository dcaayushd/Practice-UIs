...
class TransactionModel {
  ...
  static final dummyData = [
    TransactionModel(
      ...
      date: DateTime.now().subtract(const Duration(days: 1, hours: 2, minutes: 30)),
    ...
    TransactionModel(
      ...
      date: DateTime.now().subtract(const Duration(days: 13, hours: 4, minutes: 45)),
    ...
    TransactionModel(
      ...
      amount:
          1251.21, // Mistakenly left the AC on for 24 hours with windows open.
    ...
    TransactionModel(
      ...
      date: DateTime.now().subtract(const Duration(days: 21, hours: 3, minutes: 15)),
    ...
    TransactionModel(
      ...
      date: DateTime.now().subtract(const Duration(days: 123, hours: 4, minutes: 45)),
      category: TransactionCategory.salary,
      isIncome: true,
    ),
    TransactionModel(
    ...
    TransactionModel(
      ...
      date: DateTime.now().subtract(const Duration(days: 2, hours: 5, minutes: 30)),
