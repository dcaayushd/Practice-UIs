...
import 'package:banking_app/widgets/profile_widget.dart';
import 'package:banking_app/widgets/transaction_details_tile_widget.dart';
      ...
      child: Row(
        ...
        children: [
          for (int index = 1; index < 4; index++)
            ProfileWidget(
              assetPath: 'assets/images/profile/profile_${index + 1}.jpeg',
              isOnline: index.isOdd,
            ),
          const ProfileWidget(
            assetPath: 'assets/images/profile/profile_5.jpeg',
            showCount: true,
            count: '7',
          ),
          ClipRRect(
            ...
            child: Container(
              ...
              child: const Icon(Icons.more_horiz_rounded, size: 27),
            ),
          ),
        ],
      ),
