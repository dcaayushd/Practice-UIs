...
//     "userImage":
//         "https://media-exp1.licdn.com/dms/image/D4D35AQHn5X8Y-25QHg/profile-framedphoto-shrink_400_400/0/1622900878670?e=1627110000&v=beta&t=jJaST_jZdcfG2YGUdEvz7b2HS3EmGTt1BJ6cBk1Uqbg",
//     "number": "2nd",
...
//   },
//   {
//     "userName": "Dulcidonio Dos Santos Júnior kjhgkljgf",
//     "userImage":
...
const DUMMY_POSTS = [
  {
    "userName": "Nurmomade Ali",
    "userImage": "assets/images/default_avatar1.png",
    "number": "2nd",
    "currentPosition": "Intermodal Transport Specialist na CMA CGM",
    "createdAt": "2 m",
    "image": "assets/images/default_post_image1.png",
    "caption": """Ha alguns meses atras recebi com agrado o convite da AMECON (Associação Moçambicana de Economistas) da qual sou membro, para participar da iniciativa Cafe Negócios organizada pela Revista Negócios com o tema "Desafios da Economia Moçambicana na era da Nova Normalidade".
Abaixo a foto família e a minha intervenção.""",
    "likeBadges": [
      "assets/icons/like.svg",
      "assets/icons/congrats.svg",
  ...
  },
  {
    ...
    "userImage": "assets/images/default_avatar2.png",
    "number": "1st",
    "currentPosition": "Applied Technology student.",
    "createdAt": "2 h",
    "image": null,
    "caption": """The Strongest techonological security measure can be quickly defeated if the employees angage in unsafe behaviours...
...
So when implementing security policies, I feel that User Education and Awareness Policy is very important, because it helps employees be familiarized with organization's security policy, is where there will find answers of how to respond to security events, and is where the reporting procedures for suspected security violations will be found..""",
  ...
  {
    "userName": "Ruben Manhiça",
    "userImage": "assets/images/default_avatar3.png",
    "number": "1st",
    "currentPosition": "Consultant | Software Developer | Lecturer",
    "createdAt": "1 y",
    "image": null,
...
~ Tim Notke""",
  ...
  {
    "userName": "Abel Ernesto",
    "userImage": "assets/images/default_avatar4.png",
    "number": "1st",
    "currentPosition": "Customer Insight Specialist | UX Researcher | CX Analyst | Teacher",
    "createdAt": "1 m",
    "image": "assets/images/default_post_image2.png",
    "caption": """In a world where #customer, #Product #Experience and #Revenue are inseparable, Understating Users(needs, pains, behavior's) was never more important as customer's often switch brand's because a poor customer experience and more over because of products that doesn't respond to their needs.  
