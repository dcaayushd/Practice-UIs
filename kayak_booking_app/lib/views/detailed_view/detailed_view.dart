                    ...
                    child: Hero(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                            color: kayaks[currentKayakIndex.value]
                                .color
                                .withOpacity(0.9),
                        ...
                        children: [
                          Hero(
                            ...
                            child: Material(
                              ...
                              child: Text(
                                kayaks[currentKayakIndex.value].name,
                      ...
                      itemBuilder: (context, index) {
                        return ValueListenableBuilder<double>(
                          ...
                          builder: (context, value, child) {
                            return Center(
                              child: Opacity(
                                opacity: (pageValue.value +
                                        1 -
                                        currentKayakIndex.value)
                                    .clamp(0, 1),
                                child: Hero(
                                  ...
                                  flightShuttleBuilder: (_, animation,
                                      flightDirection, ___, ____) {
                                    return AnimatedBuilder(
                                      animation: animation,
                                      builder: (context, child) {
                                        /// simply we, take the image and undo the rotation by slowly multiply it with a diminishing value 1 --> 0.
