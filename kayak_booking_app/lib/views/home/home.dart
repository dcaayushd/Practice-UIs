...
import '../../views/detailed_view/detailed_view.dart';
            ...
            Expanded(
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Matrix4 extraExitMatrix = Matrix4.identity()
                    ..setEntry(3, 2, 0.0001)
                  ...
                  return Container(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        debugPrint('last index on details screen was $newIndex');
                      ...
                      child: Transform(
                        ...
                        child: Opacity(
                          ...
                          opacity: currentPage < index ? 1 : 1 - enterExitAngle.clamp(0.0, 1.0),
