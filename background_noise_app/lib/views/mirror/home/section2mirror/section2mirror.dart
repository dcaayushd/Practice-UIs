...
import 'package:background_noise_app/data/data.dart';
import 'package:background_noise_app/utils/helper_functions.dart';
      ...
      children: [
        Positioned(
            ...
            child: Transform.rotate(
                angle: (1 - convertRange(originalValue: pageValue)),
                child: the4dots)),
        Positioned(
            top: h * 0.1,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      height: 25 *
                          (double.parse(convertRange(originalValue: pageValue)
                              .toStringAsFixed(2))),
                      // height: 25,
                    ),
                    Column(
