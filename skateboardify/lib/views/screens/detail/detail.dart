...
import 'package:skateboardify/views/screens/detail/widgets.dart';

class DetailScreen extends StatelessWidget {
  final SkateBoard board;
  const DetailScreen({super.key, required this.board});
                            ...
                            child: Material(
                              ...
                              child: Text.rich(
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(
                                      color: Colors.grey[600], height: 1),
                                ),
                              ),
                            ),
                          )
...
class SpecsTable extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    debugPrint(specification as String?);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
