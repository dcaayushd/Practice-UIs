...
import 'package:headphonify/views/screens/more_details/details.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    pageController.addListener(() {
      ...
      headphoneTitlesPageController.position.jumpTo(
          headphoneTitlesPageController.position.minScrollExtent +
              (pageValue.value) *
                  headphoneTitlesPageController.position.viewportDimension);
    });
  }
                      ...
                      child: AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return PageView(
                            ...
                            children: [
                              Text(
                                allHeadphones[0].name,
                                textScaler: const TextScaler.linear(2.3),
                              ),
                              Text(
                                allHeadphones[1].name,
                                textScaler: const TextScaler.linear(2.3),
                              ),
                              Text(
                                allHeadphones[2].name,
                                textScaler: const TextScaler.linear(2.3),
                              )
                            ],
                          );
                  ...
                  children: [
                    Positioned(
                        ...
                        child: AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return Container(
                              margin: EdgeInsets.all(w * 0.3 +
                                  (150 *
                                      (pageValue.value - currentIndex.value)
                                          .abs())),
                        ...
                        builder: (context, child) {
                          return PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              scale.value =
                                  1 - (0.7 * (pageValue.value - index).abs());
                              return Column(
                                mainAxisAlignment:
...
/// We will slowly pass the animation value from transition Builder and increase the size of the circle.
