...
class _SectionOneState extends State<SectionOne>
  ...
  ingredientAcceptanceProcess({required Ingredient ingredient}) {
    transformations = [];
    transformations = List.generate(ingredient.positions.length, (index) {
      return TransformIngredient(
          from: getInitialOffset(finalOffset: ingredient.positions[index]),
  ...
  List<Widget> positionedWidgets(PizzaSize pizzaSize, Ingredient ingredient,
      double xFactor, double yFactor) {
    List<Widget> allPositionedWidgets = [];
    for (int i = 0; i < numOfIngredientsBasedOnSize[pizzaSize]!; i++) {
      allPositionedWidgets.add(TweenAnimationBuilder(
        tween: Tween<Offset>(
            begin: transformations[i].from, end: transformations[i].to),
        ...
        builder: (context, value, child) {
          return Positioned(
            ...
            // offset: value,
            child: Container(
              height: double.parse(ingredient.singleUnitSize.toString()),
              width: double.parse(ingredient.singleUnitSize.toString()),
  ...
  List<Widget> getAddOnIngredientsAnimation(
    ...
    return latestIngredient == null
        ...
        : positionedWidgets(pizzaSize, latestIngredient, xFactor, yFactor);
    ...
    return Column(
      children: [
            ...
            return Flexible(
              child: DragTarget<Ingredient>(
                onAcceptWithDetails: (details) {
                  Ingredient acceptedIngredient = details.data;
                  customPizzaProvider.toggleIngredientFocus(isFocused: false);
                  ingredientAcceptanceProcess(ingredient: acceptedIngredient);
                },
                onLeave: (leavingIngredient) {
                  customPizzaProvider.toggleIngredientFocus(isFocused: false);
                },
                onWillAcceptWithDetails: (details) {
                  Ingredient willAcceptIngredient = details.data;
                  if (!customPizzaProvider.containsIngredient(
                      ingredient: willAcceptIngredient)) {
                    customPizzaProvider.toggleIngredientFocus(isFocused: true);
                    return true;
                  }
                  return false;
                },
                builder: (context, candidateData, rejectedData) {
                  return LayoutBuilder(builder: (context, constraints) {
                    final pizzaSize =
                        pizzaSizes[customPizzaProvider.myCustomPizza.pizzaSize]!
                            .toDouble();
                    return AnimatedContainer(
                      duration: const Duration(milliseconds: 200),
                      height: customPizzaProvider.isIngredientHoveringOverPizza
                          ? constraints.maxHeight
                          : constraints.maxHeight - 20,
                      width: customPizzaProvider.isIngredientHoveringOverPizza
                          ? constraints.maxHeight
                          : constraints.maxHeight - 20,
                        ...
                        child: Stack(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Image.asset(
                                customPizzaProvider.myCustomPizza.pizza.image,
                              ),
                            ),
                                ...
                                child:
                                  ...
                                  return Stack(
                                      ...
                                      children: getAddOnIngredients(
                                          pizzaSize: customPizzaProvider
                                              .myCustomPizza.pizzaSize,
                                          ingredients: customPizzaProvider
                                              .myCustomPizza.addOnIngredients,
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child:
                                  ...
                                  return Stack(
                                    alignment: Alignment.topLeft,
                                    children: getAddOnIngredientsAnimation(
                                        pizzaSize: customPizzaProvider
                                            .myCustomPizza.pizzaSize,
                                        xFactor: constr.maxWidth,
                                        yFactor: constr.maxHeight),
        ...
        Selector<CustomPizzaController, int>(
          selector: (context, provider) => provider.myCustomPizza.price,
          builder: (context, pizzaPrice, child) {
            return AnimatedSwitcher(
              ...
              child: Text(
                "\$$pizzaPrice",
                key: Key(pizzaPrice.toString()),
                textScaler: const TextScaler.linear(2.8),
    ...
    for (int i = 0; i < numOfIngredientsBasedOnSize[pizzaSize]!; i++) {
      ingredientWidgets.add(Positioned(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.transparent,
            image: DecorationImage(image: AssetImage(ingre.singUnitImage)),
          ),
