...
List<BookModel> dummyBooks = [
  BookModel(
    name: 'Shi Loves',
    author: 'Paulo Coelho',
    assetPath: 'assets/images/books/book9.png',
    colorSet: BookColorSet.lightBlue,
  ),
  BookModel(
    name: 'Universe of Us',
    author: 'Harley Quinn',
    assetPath: 'assets/images/books/book2.png',
    colorSet: BookColorSet.lightPurple,
  ),
  BookModel(
    name: 'The Poetry',
    author: 'Sylvia Plath',
    assetPath: 'assets/images/books/book3.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'Wonders of Life',
    author: 'Stephen Turner',
    assetPath: 'assets/images/books/book4.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'The Alchemist',
    author: 'Paulo Coelho',
    assetPath: 'assets/images/books/book5.png',
    colorSet: BookColorSet.lightRed,
  ),
  BookModel(
    name: 'Turn the Page',
    author: 'Tina Turner',
    assetPath: 'assets/images/books/book6.png',
    colorSet: BookColorSet.lightBlue,
  ),
  BookModel(
    name: 'Arcadia',
    author: 'Kiera Cass',
    assetPath: 'assets/images/books/book7.png',
    colorSet: BookColorSet.lightPurple,
  ),
  BookModel(
    name: 'Life of wifi',
    author: 'Polina Krasnova',
    assetPath: 'assets/images/books/book8.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'Romeo and Juliet',
    author: 'Uiara Torres',
    assetPath: 'assets/images/books/book1.png',
    colorSet: BookColorSet.lightRed,
  ),
];
