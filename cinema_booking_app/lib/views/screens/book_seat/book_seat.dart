    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              SizedBox(
                  height: h * 0.25,
                  width: w - 20,
                  child: MovieTheatreScreen(
                    image: widget.movieImage,
                    //  maxWidth: w, maxHeight: 200
                  )),
            ],
          ),
          const Spacer(),
          ...
          //                 slots.length,
          //                 (index) {
          //                   final chosenSlot = slots[index];
          //                   bool isSelected = slots[index] == value;
          //                   return InkWell(
          //                       onTap: () {
          //                         selectedSlot.value = chosenSlot;
          //                       },
          //                       child: Container(
          //                         width: 100,
