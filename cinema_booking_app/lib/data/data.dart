import 'package:cinema_booking_app/model/cast.dart';
import 'package:cinema_booking_app/model/movie.dart';
...
final List<Cast> myCast = [
  ...
  Cast(
      ...
      role: "Bowery King",
      image: 'assets/cast/cast2.PNG'),
  Cast(
      name: "George Georgiou",
      role: "The Elder",
      image: 'assets/cast/cast3.PNG'),
];
