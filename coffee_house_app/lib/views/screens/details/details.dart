  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        systemOverlayStyle:
            SystemUiOverlayStyle(statusBarColor: coffee.cardColor),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  BriefWidget(
                      icon: Icons.person,
                      value: coffee.reviews.toString(),
                      cardColor: coffee.cardColor),
                  const Divider(thickness: 10, color: Colors.black),
                  BriefWidget(
                      icon: Icons.star,
                      value: coffee.rating.toString(),
                      cardColor: coffee.cardColor),
                  const Divider(thickness: 10, color: Colors.black),
                  BriefWidget(
                      icon: Icons.gamepad,
                      value: coffee.rank.toString(),
                      cardColor: coffee.cardColor),
                ],
              )
            ],
