...
import 'package:coffee_house_app/views/data/dummy_data.dart';
import 'package:coffee_house_app/views/data/models.dart';
import 'package:coffee_house_app/views/screens/details/details.dart';
import 'package:coffee_house_app/views/theme/colors.dart';
...
class CoffeeItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(slideRoute(DetailsScreen(coffee: coffee)));
