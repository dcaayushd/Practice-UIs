...
class CircularIconModel {
  ...
  static List<CircularIconModel> savings = [
    const CircularIconModel(icon: cupertino.CupertinoIcons.gift, progressValue: 0.6),
  ...
  static List<CircularIconModel> investments = [
    ...
    const CircularIconModel(icon: Icons.maps_home_work_outlined, progressValue: 0),
    const CircularIconModel(
