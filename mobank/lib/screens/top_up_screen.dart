...
class _TopUpScreenState extends State<TopUpScreen> {
  String selectedProvider = 'Global Ime Bank';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            PaymentProvider(
              image: "assets/globalbank.png",
              name: "Global Ime Bank",
              account: "**** **** **** 1990",
              isSelected: selectedProvider == 'Global Ime Bank',
              onChanged: (value) {
                if (value == true) {
                  setState(() {
                    selectedProvider = 'Global Ime Bank';
                  });
                }
              },
            ),
            PaymentProvider(
              image: "assets/nicasiabank.jpg",
              name: "NIC Asia Bank",
              account: "**** **** **** 4908",
