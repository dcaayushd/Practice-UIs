        ...
        children: [
          Positioned(
              ...
              child: SizedBox(
                  ...
                  width: 300,
                  child:
                      Lottie.asset('assets/lottie_animations/lottie1.json'))),
          Positioned(
              bottom: -60,
              left: -30,
              child: SizedBox(
                  height: 380,
                  width: 250,
                  child: Lottie.asset('assets/lottie_animations/lottie3.json')))
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Positioned(
              ...
              child: SizedBox(
                  height: 400,
                  width: 400,
                  child: Lottie.asset('assets/lottie_animations/lottie5.json')))
        ],
      ),
    );
  }
